...
- [Public-release policy](security/PUBLIC_RELEASE_POLICY.md)

## Models And Research

- [Model catalog](models/MODEL_CATALOG.md)
- [Literature-driven roadmap](research/LITERATURE_ROADMAP.md)
- [Per-checkpoint spectral-expander and 2024-2026 literature update](research/PER_CHECKPOINT_SPECTRAL_EXPANDER_AND_2026_LITERATURE_UPDATE_20260713_CN.md)
- [Current evidence status](research/CURRENT_STATUS.md)
- [English 2026-08-23 handoff](research/ENGINEERING_HANDOFF_20260823_EN.md)
- [Offline evidence SHA-256 identities](research/EVIDENCE_SHA256_20260823.txt)

## Reference

- [Complete script catalog](SCRIPT_CATALOG.md)
- [GitHub publishing procedure](PUBLISHING.md)
- [Grounded S4P port contract](MARS56_GROUNDED_S4P_PORT_CONTRACT_20260702_CN.md)
- [EMX symmetry augmentation protocol](REAL_EMX_SYMMETRY_AUGMENTATION_PROTOCOL_20260712_CN.md)
