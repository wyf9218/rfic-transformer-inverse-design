...
import maintenance_window as maintenance
...
def allocated_snapshot(root, candidate_roots):
    from allocation_walk import allocated_snapshot as fresh_walk
    return fresh_walk(root, candidate_roots)
