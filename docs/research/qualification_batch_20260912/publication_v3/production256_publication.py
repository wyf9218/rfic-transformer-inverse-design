...
def validate_member(result,feature,contract,receipt):
    ...
    if p['source']=='TRAIN_NEIGHBORHOOD':
        require(p['assigned_development_split']=='train' and p['base_metadata']['assigned_development_split']=='train'
                and p['final_independent_test_eligible'] is False,'neighborhood train family split drift')
