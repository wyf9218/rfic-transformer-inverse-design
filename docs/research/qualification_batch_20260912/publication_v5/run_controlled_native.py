...
class Owner(PreviousOwner):
    ...
    def verify_release(self):
        ...
        m.require(self.config['max_native_concurrency']==(48 if self.release.get('concurrency_amendment') else 1),
    ...
    def cadence_command(self, root):
        return [*super().cadence_command(root), '--port-endpoint-policy', 'shared_port_edges_20260912_v1']
